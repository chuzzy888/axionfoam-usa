...
export const Loader = () => {
  const [mvval, setMyval] = useState("d");
  ...
  useEffect(() => {
    if (run === false) {
      ...
      if ($(".shop-detail-section").length) {
        var thumbsCarousel = new Swiper(
          ".shop-detail-section .thumbs-carousel",
          {
            ...
            autoplay: 6000,
            navigation: {
              nextEl: ".swiper-button-next", // Specify the CSS selector for the next arrow
              prevEl: ".swiper-button-prev", // Specify the CSS selector for the previous arrow
            },
            breakpoints: {
              320: {
                spaceBetween: 20,
      ...
      return () => {
        // Remove all event listeners and other cleanup operations
        $(".preloader-close").off("click");
        $(".main-header li.dropdown .dropdown-btn").off("click");
        $(".fullscreen-menu .navigation li.dropdown > a").off("click");
        $(".main-header .navigation li.dropdown > a").off("click");
        $(
          ".main-header .navigation li.dropdown > a, .hidden-bar .side-menu li.dropdown > a"
        ).off("click");
        $(".cart-box .dropdown-menu").off("click");
        $(".select-categories").off("click");

        // Remove any other listeners or cleanup operations you added
      };
    }
  }, []);
  // console.log(run);
